...
![](posterior_gravity_2019-08-06_files/figure-gfm/unnamed-chunk-4-1.png)<!-- -->
...
![](posterior_gravity_2019-08-06_files/figure-gfm/unnamed-chunk-4-2.png)<!-- -->

``` r
pairs(s_near, pch = 21, main = "distance near")
```

![](posterior_gravity_2019-08-06_files/figure-gfm/unnamed-chunk-4-3.png)<!-- -->

``` r
pairs(s_far, pch = 21, main = "distance far")
```

![](posterior_gravity_2019-08-06_files/figure-gfm/unnamed-chunk-4-4.png)<!-- -->
...
![](posterior_gravity_2019-08-06_files/figure-gfm/unnamed-chunk-6-1.png)<!-- -->

``` r
plot_scatter_bars(df_poi, 4:13, 100)
```

![](posterior_gravity_2019-08-06_files/figure-gfm/unnamed-chunk-6-2.png)<!-- -->

``` r
plot_scatter_bars(df_poi, 4:13, 20)
```

![](posterior_gravity_2019-08-06_files/figure-gfm/unnamed-chunk-6-3.png)<!-- -->
...
![](posterior_gravity_2019-08-06_files/figure-gfm/unnamed-chunk-7-1.png)<!-- -->

``` r
plot_scatter_bars(df_negbin, 4:13, 100)
```

![](posterior_gravity_2019-08-06_files/figure-gfm/unnamed-chunk-7-2.png)<!-- -->

``` r
plot_scatter_bars(df_negbin, 4:13, 20)
```

![](posterior_gravity_2019-08-06_files/figure-gfm/unnamed-chunk-7-3.png)<!-- -->
...
![](posterior_gravity_2019-08-06_files/figure-gfm/unnamed-chunk-8-1.png)<!-- -->

``` r
plot_scatter_bars(pred_w_mul, 1:11, 100)
```

![](posterior_gravity_2019-08-06_files/figure-gfm/unnamed-chunk-8-2.png)<!-- -->

``` r
plot_scatter_bars(pred_w_mul, 1:11, 20)
```

![](posterior_gravity_2019-08-06_files/figure-gfm/unnamed-chunk-8-3.png)<!-- -->
