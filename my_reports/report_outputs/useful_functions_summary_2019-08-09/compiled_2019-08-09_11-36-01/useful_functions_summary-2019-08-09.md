...
``` r
setup <- function(test_dat_mul_with_w_filename){
  ###
  # setup() is a helper function to populate the global variables rel_dat_mul
  # and test_dat_mul using the given file name
  #
  # Input:
  #   test_dat_mul_with_w_filename: the filename for test_dat_mul_with_w,
  #                                 which should contain everything useful
  #                                 for both rel_dat_mul and test_dat_mul.
  #
  # Output:
  #   populate the global variables rel_dat_mul and test_dat_mul
  ###
  ...
  get_test_dat_mul <- function(){
    test_dat_mul <- test_dat_mul_with_w[,1:25]
    return(test_dat_mul)
  }
  
  get_rel_dat_mul <- function(){
  ...
  print("preparing test_dat_mul...")
  test_dat_mul <<- get_test_dat_mul()
  print("preparing rel_dat_mul...")
  rel_dat_mul <<- get_rel_dat_mul()
  print("Jobs Done!")
}
```
...
``` r
mul_predict <- function(coefficient_matrix){
  ###
