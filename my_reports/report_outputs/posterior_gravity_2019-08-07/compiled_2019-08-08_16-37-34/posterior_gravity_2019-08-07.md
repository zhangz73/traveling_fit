...
![](posterior_gravity_2019-08-07_files/figure-gfm/unnamed-chunk-5-1.png)<!-- -->
...
![](posterior_gravity_2019-08-07_files/figure-gfm/unnamed-chunk-5-2.png)<!-- -->

``` r
pairs(s_near, pch = 21, main = "distance near")
```

![](posterior_gravity_2019-08-07_files/figure-gfm/unnamed-chunk-5-3.png)<!-- -->

``` r
pairs(s_far, pch = 21, main = "distance far")
```

![](posterior_gravity_2019-08-07_files/figure-gfm/unnamed-chunk-5-4.png)<!-- -->
...
![](posterior_gravity_2019-08-07_files/figure-gfm/unnamed-chunk-9-2.png)<!-- -->
