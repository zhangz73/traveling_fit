...
![](posterior_gravity_2019-08-07_files/figure-gfm/unnamed-chunk-24-1.png)<!-- -->
...
![](posterior_gravity_2019-08-07_files/figure-gfm/unnamed-chunk-24-2.png)<!-- -->

``` r
pairs(s_near, pch = 21, main = "distance near")
```

![](posterior_gravity_2019-08-07_files/figure-gfm/unnamed-chunk-24-3.png)<!-- -->

``` r
pairs(s_far, pch = 21, main = "distance far")
```

![](posterior_gravity_2019-08-07_files/figure-gfm/unnamed-chunk-24-4.png)<!-- -->
...
![](posterior_gravity_2019-08-07_files/figure-gfm/unnamed-chunk-26-1.png)<!-- -->

``` r
plot_scatter_bars(df_poi, 4:13, 100)
```

![](posterior_gravity_2019-08-07_files/figure-gfm/unnamed-chunk-26-2.png)<!-- -->

``` r
plot_scatter_bars(df_poi, 4:13, 20)
```

![](posterior_gravity_2019-08-07_files/figure-gfm/unnamed-chunk-26-3.png)<!-- -->
...
![](posterior_gravity_2019-08-07_files/figure-gfm/unnamed-chunk-27-1.png)<!-- -->

``` r
plot_scatter_bars(df_negbin, 4:13, 100)
```

![](posterior_gravity_2019-08-07_files/figure-gfm/unnamed-chunk-27-2.png)<!-- -->

``` r
plot_scatter_bars(df_negbin, 4:13, 20)
```

![](posterior_gravity_2019-08-07_files/figure-gfm/unnamed-chunk-27-3.png)<!-- -->
...
![](posterior_gravity_2019-08-07_files/figure-gfm/unnamed-chunk-28-1.png)<!-- -->

``` r
plot_scatter_bars(pred_w_mul, 1:11, 100)
```

![](posterior_gravity_2019-08-07_files/figure-gfm/unnamed-chunk-28-2.png)<!-- -->

``` r
plot_scatter_bars(pred_w_mul, 1:11, 20)
```

![](posterior_gravity_2019-08-07_files/figure-gfm/unnamed-chunk-28-3.png)<!-- -->
