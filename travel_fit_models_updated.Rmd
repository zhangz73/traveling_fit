...
knitr::include_graphics("zinf_dist_noCov_cutoff=0.png")
```

To see a complete summary of AIC and Sum of Residual Squares of each model at each cutoff, view the [summary.csv](./summary.csv)